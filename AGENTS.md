...
- In this private fork, commit completed, verified work autonomously. Leave changes uncommitted only when the user asks, verification is failing, or the work is intentionally incomplete.
